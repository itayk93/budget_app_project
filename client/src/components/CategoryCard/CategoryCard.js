...
const CategoryCard = ({ categoryName, categoryData, formatCurrency, formatDate, onDataChange, year, month, isInGroup = false, isEmpty = false, onRemoveEmpty = null, isDemoMode = false }) => {
