-- Enable Row Level Security (RLS) for Budget App Tables - CORRECTED VERSION
-- This script enables RLS and creates secure access policies for actual existing tables
...
-- Enable RLS on bank scraper tables (only if they exist)
...
-- Optional: Bank scraper policies (uncomment if tables exist)
